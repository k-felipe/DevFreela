...
{
    protected Project() { }
    public Project(string title, string description, int clientId, int freelancerId, decimal totalCost) : base()
    {
        Title = title;
    ...
    {
        if (Status == ProjectStatusEnum.PendingPayment || Status == ProjectStatusEnum.InProgress)
        {
